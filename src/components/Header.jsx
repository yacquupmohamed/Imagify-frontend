...
function Header() {
  ...
  return (
    <motion.div className='flex flex-col items-center justify-center textcenter my-20'
    ...
    >
        ...
        <motion.h1 className='text-4xl mx-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center'>Turn text to <span className='text-blue-600'
        initial={{opacity: 0}}
        animate={{opacity: 1}}
        ...
        initial={{opacity: 0}}
        animate={{opacity: 1}}
        transition={{defualt: {duration: 0.5}, opacity: {delay: 0.8, duration: 1}}}
